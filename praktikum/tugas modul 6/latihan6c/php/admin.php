...
<body>
    <div class="add">
        <a href="tambah.php"><button class="waves-effect waves-light btn" style="background-color: #8600f3;">Tambah Data</button></a>
    </div>
    <br>
        ...
        <?php else : ?>
            ...
            <?php foreach ($mahasiswa as $mhs) : ?>
                <tr>
                    ...
                    <td><?= $mhs['jurusan']; ?></td>
                    <td>
                        <a href="detail.php?id=<?= $mhs['id'] ?>" style="text-decoration: none; color: white;">Lihat</a>
                    </td>
                </tr>
                <?php $i++; ?>
            <?php endforeach; ?>

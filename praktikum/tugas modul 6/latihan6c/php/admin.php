...
<body>
    <div class="add">
        <a href="tambah.php"><button class="waves-effect waves-light btn" style="background-color: #0061a8;">Tambah Data</button></a>
    </div>
    <br>
    <form class="cari" action="" method="GET">
        <input type="text" name="keyword" autofocus placeholder="Cari Mahasiswa.." autocomplete="off">
        <button type="submit" name="cari" class="waves-effect waves-light btn" style="background-color: #0061a8;">Cari</button>
        <button type="submit" class="waves-effect waves-light btn" style="background-color: #0061a8;">
    ...
    <br>
    <br>
    <button class="btn btn-info" style="background-color: #0061a8;"><a href="logout.php" style="text-decoration: none; color: white;">Logout</a></button>
</body>
</html>